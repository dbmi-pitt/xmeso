  ...
  */  
  ...
  public String getSectionName() {
    if (PartHeader_Type.featOkTst && ((PartHeader_Type)jcasType).casFeat_sectionName == null)
      jcasType.jcas.throwFeatMissing("sectionName", "edu.pitt.dbmi.xmeso.typesystem.Typesystem.PartHeader");
  ...
  public int getPartNumber() {
    if (PartHeader_Type.featOkTst && ((PartHeader_Type)jcasType).casFeat_partNumber == null)
      jcasType.jcas.throwFeatMissing("partNumber", "edu.pitt.dbmi.xmeso.typesystem.Typesystem.PartHeader");
