 ...
 */
@Entity
@Table(name = "NCATS_ICD9_PROC", schema = "I2B2METADATA")
public class NcatsIcd9Proc implements java.io.Serializable {
	...
	public NcatsIcd9Proc() {
	}

	public NcatsIcd9Proc(String CFullname) {
		this.CFullname = CFullname;
	}

	public NcatsIcd9Proc(String CFullname, BigDecimal CHlevel, String CName,
