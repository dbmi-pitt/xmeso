...
/**
 * XmesoOntology generated by hbm2java
 */
@Entity
@Table(name = "NCATS_VISIT_DETAILS", schema = "I2B2METADATA")
public class NcatsVisitDetails implements java.io.Serializable {
	...
	public NcatsVisitDetails() {
	}

	public NcatsVisitDetails(String CFullname) {
		this.CFullname = CFullname;
	}

	public NcatsVisitDetails(String CFullname, BigDecimal CHlevel, String CName,
