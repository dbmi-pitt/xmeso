...
public class PartHeader_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.pitt.dbmi.xmeso.typesystem.Typesystem.PartHeader");
  ...
  public String getSectionName(int addr) {
      ...
      jcas.throwFeatMissing("sectionName", "edu.pitt.dbmi.xmeso.typesystem.Typesystem.PartHeader");
  ...
  public int getPartNumber(int addr) {
      ...
      jcas.throwFeatMissing("partNumber", "edu.pitt.dbmi.xmeso.typesystem.Typesystem.PartHeader");
