 ...
 */
@Entity
@Table(name = "NMVB_MESOTHELIOMA", schema = "I2B2METADATA")
public class NmvbMesothelioma implements java.io.Serializable {
	...
	public NmvbMesothelioma() {
	}

	public NmvbMesothelioma(String CFullname) {
		this.CFullname = CFullname;
	}

	public NmvbMesothelioma(String CFullname, BigDecimal CHlevel, String CName,
