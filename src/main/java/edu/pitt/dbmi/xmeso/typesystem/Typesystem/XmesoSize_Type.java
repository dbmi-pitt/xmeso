...
public class XmesoSize_Type extends XmesoNamedEntity_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.pitt.dbmi.xmeso.typesystem.Typesystem.XmesoSize");
  ...
  public float getMaxDim(int addr) {
      ...
      jcas.throwFeatMissing("maxDim", "edu.pitt.dbmi.xmeso.typesystem.Typesystem.XmesoSize");
  ...
  public float getDimOne(int addr) {
      ...
      jcas.throwFeatMissing("dimOne", "edu.pitt.dbmi.xmeso.typesystem.Typesystem.XmesoSize");
  ...
  public float getDimTwo(int addr) {
      ...
      jcas.throwFeatMissing("dimTwo", "edu.pitt.dbmi.xmeso.typesystem.Typesystem.XmesoSize");
  ...
  public float getDimThree(int addr) {
      ...
      jcas.throwFeatMissing("dimThree", "edu.pitt.dbmi.xmeso.typesystem.Typesystem.XmesoSize");
  ...
  public String getUom(int addr) {
      ...
      jcas.throwFeatMissing("uom", "edu.pitt.dbmi.xmeso.typesystem.Typesystem.XmesoSize");
