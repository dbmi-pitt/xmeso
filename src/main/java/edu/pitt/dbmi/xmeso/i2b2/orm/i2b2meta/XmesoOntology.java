 ...
 */
@Entity
@Table(name = "XMESO_ONTOLOGY", schema = "I2B2METADATA")
public class XmesoOntology implements java.io.Serializable {
	...
	public XmesoOntology() {
	}

	public XmesoOntology(String CFullname) {
		this.CFullname = CFullname;
	}

	public XmesoOntology(String CFullname, BigDecimal CHlevel, String CName,
