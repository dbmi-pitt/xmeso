 ...
 * @generated */
public class DeIdBannar extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(DeIdBannar.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected DeIdBannar() {/* intentionally empty block */}
   ...
   */
  public DeIdBannar(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public DeIdBannar(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
