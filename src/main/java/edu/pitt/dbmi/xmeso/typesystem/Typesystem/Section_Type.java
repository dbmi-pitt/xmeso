...
public class Section_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.pitt.dbmi.xmeso.typesystem.Typesystem.Section");
  ...
  public String getName(int addr) {
      ...
      jcas.throwFeatMissing("name", "edu.pitt.dbmi.xmeso.typesystem.Typesystem.Section");
