 ...
 */
@Entity
@Table(name = "NCATS_DEMOGRAPHICS", schema = "I2B2METADATA")
public class NcatsDemographics implements java.io.Serializable {
	...
	public NcatsDemographics() {
	}

	public NcatsDemographics(String CFullname) {
		this.CFullname = CFullname;
	}

	public NcatsDemographics(String CFullname, BigDecimal CHlevel, String CName,
